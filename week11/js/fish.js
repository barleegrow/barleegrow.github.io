...
const apiURL = 'https://api.openweathermap.org/data/2.5/weather?zip=832873&units=imperial&APPID=0b991a27171c24f0a1099f22e88cd0eb';
...
const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?zip=832873&units=imperial&APPID=0b991a27171c24f0a1099f22e88cd0eb';
fetch(apiURL2)
.then((response) => response.json())
.then((jsObject) => {
console.log(jsObject);
